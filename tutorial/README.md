...
1. Open `plans/minecraft-mod-creation-guide.md` to see the big picture. Read it like a roadmap, not like code.
2. Skim `docs/` if you want examples of how features are explained to players.
3. Follow `tutorial/first-mod-walkthrough.md` (next file in this folder) for a slow, beginner-friendly path to creating a tiny feature.
...
1. Run `gradle build` from the repository root. It downloads dependencies and compiles the mod.
...
## Grade / evaluation (why it matters)
